				...
				<div class="container-fluid d-flex flex-column p-0">
					...
					<ul class="navbar-nav text-light" id="accordionSidebar">
						...
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/admin-promotions"><i class="fa fa-gift"
								style="font-size: 1.3rem"></i><span class="nav-item-content">Promotions</span></a></li>
					</ul>
...
<%--content--%>
								<div class="container-fluid px-container">
										...
										<form action="${pageContext.request.contextPath}/admin-add-variant" method="POST">
												...
												<div class="col d-flex justify-content-center">
														<div class="card w-50">
																<div class="card-body">
																		...
																		<div>
<%--color --%>												<label class="mt-3"><strong>Color</strong></label>
																		...
																		<div>
<%--size --%>													<label class="mt-3"><strong>Size</strong></label>
...
<%-- qty_in_stock --%>								<input class="form-control" type="number" id="qtyStock" name="qty_in_stock" placeholder="Quantity" min="0"/>
																		</div>
																		<div>
																			<label class="mt-3"><strong>Price</strong></label>
<%-- price --%>												<input class="form-control" type="number" name="price" placeholder="Price" min="0"/>
																		</div>
																</div>
														<div class="card mb-3">
															<div class="card-body">
