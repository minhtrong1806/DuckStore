								...
								<div class="container-fluid">
										...
										<div
												...
												<div class="mt-4">
														<h4
																...
																style="color: var(--gray-dark)">Order #123</h4>
														<p
																class="f"
																style="line-height: 20px">
																<span
																		style="color: rgb(137, 134, 141); background-color: rgb(244, 245, 250)">22/12/2023</span><br />
														</p>
												</div>
												<div
														class="d-flex justify-content-end justify-content-xl-end w-50">
														<button
										...
										<div class="row d-flex justify-content-xl-center px-5">
												<div class="col">
														<div class="card mb-3">
																<div class="card-body">
																		<h5 class="font-weight-bold text-dark mb-4">Order
																				detail</h5>
														...
														<div class="card mb-3">
																<div class="card-body">
																		<h5 class="font-weight-bold text-dark mb-4">Shipping
																				activity</h5>
																</div>
														</div>
												</div>
												<div class="col-xl-5">
														<div class="card mb-3">
																<div class="card-body">
																		<h5 class="font-weight-bold text-dark mb-4">Customer
																				detail</h5>
																		<div class="d-flex justify-content-start mb-2">
																				<span>Name:</span><span class="ml-5">Minh
																						Trong</span>
																		</div>
																		<h6 class="font-weight-bold text-dark mb-4">Contact
																				info</h6>
														...
														<div class="card">
																<div class="card-body">
																		<h5 class="font-weight-bold text-dark mb-4">
																				<span style="color: rgb(84, 79, 90)">Shipping
																						and billing address</span> <br />
																		</h5>
																		<div class="card mb-3">
																				...
																				<div class="card-body">
																						<p class="card-text">Nullam id dolor id nibh
