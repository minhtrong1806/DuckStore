                ...
                <div class="card shadow">
                    <div class="card-body" style="padding-top: 0px">
                        <div class="row m-3 d-xl-flex justify-content-xl-end ">
                            <div class="my-2">
                                <a href="${pageContext.request.contextPath}/admin-category/showAdd"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a class="btn btn-success mx-2"
                                                   href="${pageContext.request.contextPath}/admin-category/showEdit?CategoryName=${category.getCategoryName() }">Detail</a>
                                                <a class="btn btn-danger mx-2"
                                                   onclick="deleteConfirm(${category.getProductCategoryID() });">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
