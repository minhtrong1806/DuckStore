												...
												<div class="col">
														<form>
																<div class="card shadow mb-3">
																		<div
																				class="card-header d-flex justify-content-between align-items-xl-center py-3">
																				<p
																						class="text-primary d-inline-block m-0 font-weight-bold">Info</p>
																				<button
																		...
																		<div class="card-body">
																				...
																				<div class="form-row">
																						<div class="col">
																								<div class="form-group">
																										<label for="first_name"><strong>Phone
																						...
																						<div class="col">
																								<div class="form-group">
																										<label for="last_name"><strong>Role</strong></label><select
																												class="form-control">
																												<optgroup label="Role">
																														<option
																																value="2"
														...
														<div class="card">
																<div class="card-header">
																		<p
																				...
																				aria-controls="reset_password">Reset password</p>
																</div>
																<div
