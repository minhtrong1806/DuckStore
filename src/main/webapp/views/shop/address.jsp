                ...
                <div class="tab-content">
                    <div class="card">
                        <div
                            ...
                            <a href="add-address"
                               class="flex-c-m stext-101 cl0 size-104 bg1 bor1 hov-btn1 p-lr-15 trans-04">Add</a>
                        </div>
                        <div class="card-body d-flex flex-wrap border-top">
                            ...
                            <c:forEach items="${addressList}" var="address" varStatus="i">
                                <div class="w-50 p-lr-5">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between mtext-103 cl2">
                                            <h6>Address ${i.index + 1 }</h6>
                                            <div class="d-flex justify-content-end">
                                                <a href="delete-address?addressId=${address.getAddressID()}">
