        ...
        <div class="wrap-menu-desktop how-shadow1">
            <nav class="limiter-menu-desktop container">
                ...
                <a href="home" class="logo"> <img
                        src="${pageContext.request.contextPath}/views/images/icons/logo-01.png" alt="IMG-LOGO"/> </a>
                <!-- Menu desktop -->
...
<div class="container">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        <span class="stext-109 cl4"> History </span>
    </div>
</div>
<!-- My Account -->
<!-- My Account -->
                        ...
                        <div class="border-top">
                            <div class="list-group">
                                <a
                                    ...
                                    class="font-weight-bold list-group-item list-group-item-action border-0 mb-5  active"
                    ...
                    <div class="card-body border-top">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <c:forEach items="${shopOrders}" var="shopOrder" varStatus="i">
                                    <tr>
                                        <td>${i.index + 1 }</td>
                                        <td>${shopOrder.getOrderDate()}</td>
                                        <td>${shopOrder.getOrderTotal()}</td>
                                        <td>${shopOrder.getOrderStatus().getStatus()}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
