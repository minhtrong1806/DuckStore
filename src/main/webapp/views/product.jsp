												...
												<div class="filter-col4 p-b-27">
														...
														<div class="flex-w p-t-4 m-r--5">
																<ul>
																		...
																		<li class="p-b-6"><a
																				href="#"
																				class="filter-link stext-106 trans-04"> Size S </a>
																		</li>
																		<li class="p-b-6"><a
																				href="#"
																				class="filter-link stext-106 trans-04"> Size M </a>
																		</li>
																		<li class="p-b-6"><a
																				href="#"
																				class="filter-link stext-106 trans-04"> Size L </a>
																		</li>
																		<li class="p-b-6"><a
																				href="#"
																				class="filter-link stext-106 trans-04"> Size XL
																		</a></li>
																</ul>
														</div>
												</div>
								...
								<div
										...
										<div class="block2">
												<div class="block2-pic hov-img0">
														<img
																src="${pageContext.request.contextPath}/views/images/product-01.jpg"
																alt="IMG-PRODUCT" /> <a
																href="#"
												...
												<div class="p-l-25 p-r-30 p-lr-0-lg">
														<div class="wrap-slick3 flex-sb flex-w">
																...
																<div class="slick3 gallery-lb">
																		<div
																				class="item-slick3"
																				data-thumb="${pageContext.request.contextPath}/views/images/product-detail-01.jpg">
																		...
																		<div
																				class="item-slick3"
																				data-thumb="${pageContext.request.contextPath}/views/images/product-detail-02.jpg">
																				<div class="wrap-pic-w pos-relative">
																						<img
																		...
																		<div
																				class="item-slick3"
																				data-thumb="${pageContext.request.contextPath}/views/images/product-detail-03.jpg">
																				<div class="wrap-pic-w pos-relative">
																						<img
