      ...
      >
        <div class="container-fluid d-flex flex-column p-0">
          <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
            ...
            <div class="sidebar-brand-text mx-3"><span style="font-size: 20px">DuckStore</span></div>
          </a>
          ...
          <ul class="navbar-nav text-light" id="accordionSidebar">
            <li class="nav-item" style="margin-top: 35%">
              <a class="nav-link" href="dashboard.jsp">
                ...
                <span class="nav-item-content">Dashboard</span></a
              >
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="orders.jsp">
                ...
                <span class="nav-item-content">Orders</span></a
              >
            </li>
            <li class="nav-item">
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow">
              <div class="card-body" style="padding-top: 0px">
                <div class="row mb-3">
                  <div class="col-md-6 col-xl-12 d-flex d-xl-flex justify-content-between align-items-xl-center my-2">
                    ...
                    <div
                      ...
                      id="dataTable_length"
                    >
                      <select class="d-xl-flex form-control form-control-sm custom-select custom-select-sm">
                    ...
                    <a class="btn btn-info btn-sm w-25" role="button" href="add-user.jsp">ADD</a>
                  </div>
                </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="border rounded-0 border-white d-flex justify-content-around btn-group">
                            ...
                            >
                              <a class="btn dropdown-item" role="button" href="user-detail.jsp">Detail</a
